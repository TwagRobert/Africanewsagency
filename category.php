				...
				while($selaf = $sel->fetch()){
                    ...
                    <div class="relative_position">
                        <div class="page_news_header">
                            <h2> <a href="<?=$selaf['id']?>/<?=str_replace(' ','-',$selaf['post_title'])?>"><?=$selaf['post_title']?> </a></h2>
            ...
            <div class="col-md-3 col-sm-3">
                ...
                <div class="widget">
                    <div class="tab-content">
                        <div class="slider">
						<img src="gallery/annonce.jpg">
                        <?php include 'gallery_side.php';?>
						</div>
                        <h2 class="post-title-small"> <a href="#">Subscribe to the gallery</a></h2></div>
                </div>
                <div class="widget">
                ...
                <div class="widget">
                    ...
                    <div class="tab-content">
                <?php
					$small = $con->query("SELECT * FROM `post` WHERE `category_name`='enbref' ORDER BY id DESC LIMIT 0,3");
					while($smallp = $small->fetch()){?>
                        <div class="tab-streams">
                            <h2 class="post-title-small"> 
							<a href="<?=$smallp['id']?>/<?=str_replace(' ','-',$smallp['post_title'])?>"><?=substr($smallp['post_title'],0,250)?></a>
							</h2>
                            <p class="meta"><?=$smallp['date_time']?></p>
                            <div class="clearfix"></div>
                        </div>
